...
class kohnint:
    def __init__(self, X_quad, X_full, X_bdr, layers1, layers2, theta, f, g1, g2, g3, dudxq, dudyq, dudzq, sigbdr):
        ...
        self.loss7 = tf.reduce_mean(tf.square(self.sigb - self.sigbdr_tf))
...
if __name__ == "__main__":
    ...
    # load data
    data = scipy.io.loadmat('YOUR_PATH/diripartial3dnew.mat')
    X_quad = data['X_quad']
    ...
    # model input
    model = kohnint(X_quad, X_full, X_bdr, layers1, layers2, theta, f, g1, g2, g3, dudxq, dudyq, dudzq, sigbdr)
    model.X_star = X_star
