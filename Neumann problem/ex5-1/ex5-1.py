...
class kohnint:
    def __init__(self, X_quad, X_bdr, layers1, layers2, theta, normalx, normaly, f, g, dudxq, dudyq):
        ...
        # loss
        # the weighing parameter * lebesgue measure should be 4 40 80 4e-5 for each term, common factor is factored out
...
if __name__ == "__main__":
    ...
    # load data
    data = scipy.io.loadmat('YOUR_PATH/ntneu1prj.mat')
    X_quad = data['X_quad']
    X_bdr = data['X_bdr']
    X_star = data['X_pred']
    f = data['f']
