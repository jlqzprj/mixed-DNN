...
class kohnint:
    def __init__(self, X_quad, X_full, X_bdr, layers1, layers2, theta, normalx, normaly, f, g, dudxq, dudyq):
    ...
    def train(self):
        ...
        tf_dict = {self.xq_tf: self.xq, self.yq_tf: self.yq, self.xb_tf: self.xb,
                   ...
                   self.dudyq_tf: self.dudyq,self.xf_tf: self.xf, self.yf_tf: self.yf}
...
if __name__ == "__main__":
    ...
    # load data
    data = scipy.io.loadmat('YOUR_PATH/neupartial2dsin01-2.mat')
    X_quad = data['X_quad']
    X_bdr = data['X_bdr']
    X_star = data['X_pred']
    ...
    # model input
    model = kohnint(X_quad, X_full, X_bdr, layers1, layers2, theta, nx, ny, f, g, dudxq, dudyq)
    model.X_star = X_star
