...
class kohnint:
    def __init__(self, X_quad, X_bdr, layers1, layers2, theta, n1, n2, n3, n4, n5, f, g,
                 dudx1q, dudx2q, dudx3q, dudx4q, dudx5q):
        ...
        self.loss2 = 1 * tf.reduce_mean(tf.square(self.diva + self.f_tf))
        
        self.loss3 = 10 * tf.reduce_mean(
            tf.square(self.abdr[:, 0:1] * self.n1_tf + self.abdr[:, 1:2] * self.n2_tf + self.abdr[:, 2:3] * self.n3_tf +
                      self.abdr[:, 3:4] * self.n4_tf + self.abdr[:, 4:5] * self.n5_tf - self.g_tf))
    ...
    def train(self):
        ...
        tf_dict = {self.x1q_tf: self.x1q, self.x2q_tf: self.x2q, self.x3q_tf: self.x3q,
                   ...
                   self.f_tf: self.f, self.g_tf: self.g,
                   self.n1_tf: self.n1, self.n2_tf: self.n2, self.n3_tf: self.n3,
                   self.n4_tf: self.n4, self.n5_tf: self.n5,
...
if __name__ == "__main__":
    ...
    # load data
    data = scipy.io.loadmat('YOUR_PATH/ntneudim5prj.mat')
    ...
    # model input
    model = kohnint(X_quad, X_bdr, layers1, layers2, theta, n1, n2, n3, n4, n5, f, g,
                    dudx1q, dudx2q, dudx3q, dudx4q, dudx5q)
    model.X_star = X_star
